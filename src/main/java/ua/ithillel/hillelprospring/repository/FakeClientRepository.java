...
public class FakeClientRepository {
    ...
    @PostConstruct
    public void init() {
        clients.add(new Client(3, "Nina", 18, "nina@gmail.com", 80962345434L));
        clients.add(new Client(4, "Anna", 27, "anna@gmail.com", 80973452312L));
        clients.add(new Client(5, "Aliotte", 34, "aliotte@gmail.com", 80505648657L));
    }
